    ...
    return (
      ...
      >
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <div>
              ...
              <div style={{ fontSize: 11, color: "#5a6470", fontFamily: "JetBrains Mono, ui-monospace, monospace" }}>
        ...
        <div style={{ marginBottom: 18 }}>
          ...
          >
            <thead>
              <tr style={{ borderBottom: "1px solid #d4d8df", color: "#5a6470" }}>
        ...
        <div style={{ marginBottom: 16 }}>
          ...
          <p style={{ fontSize: 11.5, color: "#3a4350", maxWidth: "75ch" }}>
            {analysis.body}
          </p>
        </div>
